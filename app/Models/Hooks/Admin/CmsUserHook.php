    ...
    */
    public function hook_before_add($request,&$postdata)
    {
        ...
        if( !empty($postdata['image_url']) ){
            $postdata['image_url'] = CustomHelper::uploadMedia('cms_users',$postdata['image_url'],'50X50');
        }
    }
