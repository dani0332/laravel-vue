...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ \Storage::url(CustomHelper::appSetting('application_setting','favicon'))  }}">
    <link href="{{ asset('admin/_assets/lib/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('admin/_assets/lib/toast/jquery.toast.min.css') }}" rel="stylesheet">
    <link href="{{ asset('admin/_assets/scss/style.css') }}" rel="stylesheet">
                ...
                <ul class="list-inline top-right-nav">
                                    ...
                                    <div class="notification-list">
                                        <a class="clearfix" href="javascript:void(0);">
                                            <span class="notification-icon">
                                                <img alt="" class="rounded-circle" src="{{ asset('admin/_assets/img/avtar-2.png') }}" width="50">
                                            </span>
                    ...
                    <li class="dropdown avtar-dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <img alt="" class="rounded-circle" src="{{ (\Storage::exists(CustomHelper::currentUser()->image_url)) ? \Storage::url(CustomHelper::currentUser()->image_url) : \URL::to('admin/_assets/img/avtar-2.png') }}" width="30">
    ...
    <div class="nano">
        <div class="nano-content sidebar-nav">
            <div class="card-body border-bottom text-center nav-profile">
                ...
                <img alt="profile" class="margin-b-10" src="{{ (\Storage::exists(CustomHelper::currentUser()->image_url)) ? \Storage::url(CustomHelper::currentUser()->image_url) : \URL::to('admin/_assets/img/avtar-2.png') }}" width="80">
...
@yield('content')
<script src="{{ asset('admin/_assets/lib/jquery/dist/jquery.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/bootstrap/js/popper.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/pace/pace.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/jasny-bootstrap/js/jasny-bootstrap.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/slimscroll/jquery.slimscroll.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/nano-scroll/jquery.nanoscroller.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/metisMenu/metisMenu.min.js') }}"></script>
<script src="{{ asset('admin/_assets/lib/toast/jquery.toast.min.js') }}"></script>
<script src="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/alertify.min.js"></script>
<script src="{{ asset('admin/_assets/js/custom.js') }}"></script>
<script src="{{ asset('admin/_assets/js/admin.js') }}"></script>
@stack('scripts')
